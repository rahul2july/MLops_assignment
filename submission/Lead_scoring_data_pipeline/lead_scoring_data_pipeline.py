...
###############################################################################
# Create a task for load_data_into_db() function with task_id 'checking_raw_data_schema'
###############################################################################
...
###############################################################################
# Create a task for raw_data_schema_check() function with task_id 'loading_data'
##############################################################################
...
###############################################################################
#build_dbs_task.set_downstream(raw_data_schema_check_task)
#raw_data_schema_check_task.set_downstream(load_data_into_db_task)
#load_data_into_db_task.set_downstream(map_city_tier_task)
#map_city_tier_task.set_downstream(map_categorical_vars_task)
#map_categorical_vars_task.set_downstream(interactions_mapping_task)
#interactions_mapping_task.set_downstream(model_input_schema_check_task)
